...
// state for the body - which attaches to (and detaches from) each open http(s)
// page to read its localStorage, the one thing this GET is not free of;
// otherwise it serves the last snapshot;
// 404 when neither
